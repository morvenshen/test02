...
def calculate_phase_data(supreme_count=300, **kwargs):
    ...
    # 新增收益率计算
    user_net_profit = total_sales - total_cost - total_fee
    total_user_cost = total_cost + total_fee  # 总成本包含手续费
    user_profit_rate = (user_net_profit / total_user_cost * 100) if total_user_cost != 0 else 0
    ...
    return pd.DataFrame([{
        ...
        "至尊总成本": total_cost,
        "交易手续费": total_fee,
        "用户净收益": user_net_profit,
        "用户净收益率(%)": user_profit_rate,  # 新增指标
